  ...
  <div class="calendarRW">
    <div v-if="selectorName === 'day'" class="calendarRW__body">
      <div class="calendarRW__header">
        <div>
          <button class="header__title" @click="openYearSelector()">
            {{ selectMonth.thisYear }}
          </button>
          <button class="header__title header__title--month" @click="openMonthSelector()">
            {{ month_name[selectMonth.thisMonth] }}
          </button>
        </div>
      ...
      <div class="calendarRW__weeksGroup">
        <ul class="weeksGroup__list">
          <li v-for="(item, i) of week_name" :key="i" class="weeksGroup__list__item">
            {{ $t(`week${i + 1}`) }}
          </li>
        </ul>
        <ul ref="days" class="weeksGroup__list days">
          <li
            v-for="(item, i) of selectMonth.every"
            :key="i"
          ...
          >
            <button
              ...
              :class="{
                ...
                today:
                  item.getFullYear() === todayMonth.thisYear &&
                  item.getDate() === todayMonth.thisDay &&
                  item.getMonth() === todayMonth.thisMonth,
                'item__button--selected':
                  item.getFullYear() === chooseTheDay.thisYear &&
                  item.getDate() === chooseTheDay.thisDay &&
                  item.getMonth() === chooseTheDay.thisMonth
              }"
    ...
    <div v-if="selectorName === 'month'" class="calendarRW__body">
      <div class="calendarRW__header">
        <button class="header__button" @click="closeMonthSelector">
          <img class="button__icon" src="./Righ-Left.svg" alt />
      ...
      <ul class="calendarRW__list">
        <li v-for="(item, i) of month_name" :key="i" class="calendarRW__list__item">
          <button
            class="item__button"
            :class="{ 'item__button--selected': selectMonth.thisMonth === i }"
            @click="setSelectMonth(i)"
          >
            <span v-if="$i18n.locale === 'zh-TW'" class="button__name button__name--month">
              {{ month_cname[i] }}
            </span>
    ...
    <div v-if="selectorName === 'year'" class="calendarRW__body yearOption">
      <div class="calendarRW__header">
        <button class="header__button" @click="back">
          <img class="button__icon" src="./Righ-Left.svg" alt />
          <span class="button__text">{{ $t('back') }}</span>
        </button>
      ...
      <ul class="calendarRW__list">
        <li v-for="(item, i) of yearOption" :key="i" class="calendarRW__list__item">
          <button
            class="item__button"
